        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">QMAX Product Orders - REJECTED</h1>
                        </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            <h3 class="card-title">Rejected Product Orders List</h3>
                        </div>
                            ...
                            <table class="table table-bordered responsive nowrap" id="datatable" width="100%">
                                ...
                                <tbody >
                                    ...
                                    <tr v-for="order in orders" :key="order.order_id ">
                                        ...
                                        <td>
                                            <router-link :to="'orderdetails/' + order.order_number " @click="setPageReferrer('REJECTED_ORDER_LIST')">View Order</router-link>
                                        </td>
                                    </tr>
