        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Registered Dealers of Guwahati</h1>
                        </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            <h3 class="card-title">Registered Dealers of Guwahati List</h3>
                        </div>
                                ...
                                <tbody >
                                    ...
                                    <tr v-for="dealer in dealers" :key="dealer.dealer_id">
                                        ...
                                        <td>
                                         ...
                                         <td>
                                             <router-link :to="'dealerdetails/' + dealer.dealer_id" @click="setPageReferrer('GUWAHATI_DEALER_LIST')">View</router-link>
                                        </td>
                                    </tr>
...
<script >
    export default {
        ...
        methods: {
            ...
            async fetchData() {  
                this.myTofunction();
                this.dataLoading = "Fetching all registered dealers of Guwahati ...";
                axios.get('/api/dealerlistbylocation/L')
                .then((response) => {
                    this.slno = 1;    
