        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Registered NON GST Dealers</h1>
                        </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            <h3 class="card-title">Registered NON GST Dealer List</h3>
                        </div>
                                ...
                                <tbody >
                                    ...
                                    <tr v-for="dealer in dealers" :key="dealer.dealer_id">
                                        ...
                                        <td>{{dealer.cityName}}</td>
                                         <td>
                                             <router-link :to="'dealerdetails/' + dealer.dealer_id" @click="setPageReferrer('NON_GST_DEALER_LIST')">View</router-link>
                                        </td>
                                    </tr>
...
<script >
    export default {
        ...
        methods: {
            ...
            async fetchData() {  
                this.myTofunction();
                this.dataLoading = "Fetching all Non GST dealers ...";
                axios.get('/api/nonGSTdealers')
                .then((response) => {
                    this.slno = 1;    
