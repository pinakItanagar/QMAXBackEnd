        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Registered Dealers outside of Guwahati</h1>
                        </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            <h3 class="card-title">Registered Dealers outside of Guwahati</h3>
                        </div>
                                ...
                                <tbody >
                                    ...
                                    <tr v-for="dealer in dealers" :key="dealer.dealer_id">
                                        ...
                                        <td>
                                         ...
                                         <td>
                                             <router-link :to="'dealerdetails/' + dealer.dealer_id" @click="setPageReferrer('OUTSIDE_GUWAHATI_DEALER_LIST')">View</router-link>
                                        </td>
                                    </tr>
...
<script >
    export default {
        ...
        methods: {
            ...
            async fetchData() {  
                this.myTofunction();
                this.dataLoading = "Fetching all dealers outside of guwahati ...";
                axios.get('/api/dealerlistbylocation/O')
                .then((response) => {
                    this.slno = 1;    
