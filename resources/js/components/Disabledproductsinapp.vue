        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">QMAX Disabled Products in App</h1>
                        </div>
                ...
                <div class="container-fluid">
                    <div class="card">
                        ...
                        <div class="card-header">
                            <h3 class="card-title">Disabled Product List in App</h3>
                        </div>
                            ...
                            <table class="table table-bordered responsive nowrap" id="datatable" width="100%">
                                ...
                                <tbody >
                                    ...
                                    <tr v-for="product in products" :key="product.product_ct_id ">
                                        ...
                                        <td>
                                            <router-link :to="'productdetails/' + product.product_ct_id" @click="setPageReferrer('DISABLED_PRODUCT_LIST_IN_APP')">View</router-link>
                                        </td>
                                        <!--
                                        <td>
...
<script >
    export default {
        ...
        methods: {
            ...
            async fetchData() {  
                this.dataLoading = "Fetching all disabled product list in APP ...";
                axios.get('/api/disabledproductsinapp')
                .then((response) => {
                    this.slno = 1;    
