                            ...
                            <table class="table table-bordered responsive nowrap" id="datatable" width="100%">
                                ...
                                <tbody >
                                    ...
                                    <tr v-for="product in products" :key="product.product_ct_id ">
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-success" @click="printQRCode(product.product_name_customer, product.part_no)" >Print QR Code</button>
                                        </td>
...
<script >
    export default {
        ...
        methods: {
            ...
            printQRCode(product_name, part_no) { 
                let productList = [] 
              
                let product = part_no + '###' +  product_name;
                productList.push( product );
                 ...
                 .then((response) => {
                    ...
                    if(response.data.op_status == true) {
                        let surl = "http://mis.qmaxonline.com:8080/downloads/"  + response.data.response_status;  
